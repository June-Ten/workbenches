window.$website = {
  ...
  name: '可视化智能数据分析平台',
  subName: '驾驭数据，助力智慧决策',
  url: window.location.origin.indexOf('localhost') ? window.location.origin + '/api' : window.location.origin,
  autoSave: false,
  autoSaveTime: 60000,
    ...
    children: [{
      ...
      option: {
        ...
        option: {
          ...
          mapData: "https://test.jinzhiyuns.com/blade-visual/map/data?id=1235103352843448322",
