<template>
  <el-collapse-item title="卡片设置" name="13">
    ...
    <el-form-item label="背景色" style="height:32px" class="cc">
      <el-color-picker v-model="activeData.card.titleBgColor" />
    </el-form-item>
<!--    <el-form-item label="图标" class="cc">-->
