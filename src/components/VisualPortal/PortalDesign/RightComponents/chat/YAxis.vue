<template>
  <el-collapse-item title="Y轴设置" name="6">
    ...
    <template v-if="activeData.option.yAxisShow">
      ...
      <el-form-item label="网格线颜色" v-if="activeData.option.yAxisSplitLineShow" style="height:32px" class="zztC">
