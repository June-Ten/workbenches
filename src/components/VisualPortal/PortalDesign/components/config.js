...
},
{
  ...
  option: {
    ...
    appColumnList: [{
      fullName: '部门',
      filedName: 'inputField102',
    },
    {
      fullName: '日期',
      filedName: 'inputField105',
    }
    ],
    columnData: [{
      fullName: '排名',
      filedName: 'inputField101',
      sortable: false,
      fixed: "none",
      align: 'center',
      width: 0,
...
export const chartComponents = [{
  icon: 'icon-ym el-icon-full-screen',
  label: '柱状图',
  jnpfKey: 'barChart',
  title: '柱状图',
  renderKey: '',
  ...
  card: {
    ...
    titleLeft: 'left',
    titleBgColor: '',
    cardIcon: 'icon-ym el-icon-full-screen',
    cardIconColor: "#606266",
    linkType: '',
    type: '',
    moduleId: '',
