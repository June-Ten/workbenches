  ...
  <div class="tools">
    <div class="tools-left">
      <div :class="['tools-icon', {clicked:this.$store.state.desktop.preferenceVisiable}]"
           @click="togglePreference()"><span class="icon-ym icon-ym-shezhi"></span></div>
      <div class="tools-icon" @click="openSafari()"><span class="icon-ym icon-ym-generator-alert"></span></div>
    </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      openSafariTal(){
        this.state.safari.active = true;
        this.state.safari.isShow = true;
      },
