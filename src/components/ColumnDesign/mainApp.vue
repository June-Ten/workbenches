      ...
      <div class="field-box">
        <div class="columnList" v-show="currentTab==='sort'">
          <el-table :data="sortOptions" class="JNPF-common-table" height="100%"
            ...
            <el-table-column prop="fullName" label="排序字段" v-else />
  ...
  created() {
    ...
    if (this.webType != 4) {
      ...
      this.$nextTick(() => {
        ...
        this.columnData.sortList = this.setListValue(this.columnData.sortList, JSON.parse(JSON.stringify(this.sortOptions)), 'sort')
      })
    } else {
