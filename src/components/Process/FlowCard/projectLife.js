...
import nodeConfig from "./lifeConfig.js";
...
export class NodeUtils {
  ...
  static isOutsourceNode(node) {
    return node && node.type === 'outsource'
  }
  static isTrailNode(node) {
    return node && node.type === 'trial'
  }
  static isLingguNode(node) {
    return node && node.type === 'linggu'
  }
  static isChangeNode(node) {
    return node && node.type === 'change'
  }
  static isFinishPNode(node) {
    return node && node.type === 'finishP'
  }
...
//   return startNode;
// }
export function getProjectLifeMockData() {
  let startNode = NodeUtils.createNode("start");
  startNode.childNode = NodeUtils.createNode("approver", startNode.nodeId);
  startNode.childNode.childNode = NodeUtils.createNode("outsource", startNode.nodeId);
  startNode.childNode.childNode.childNode = NodeUtils.createNode("trial", startNode.nodeId);
  startNode.childNode.childNode.childNode.childNode = NodeUtils.createNode("linggu", startNode.nodeId);
  startNode.childNode.childNode.childNode.childNode.childNode = NodeUtils.createNode("change", startNode.nodeId);
  startNode.childNode.childNode.childNode.childNode.childNode.childNode = NodeUtils.createNode("finishP", startNode.nodeId);
  return startNode;
}
