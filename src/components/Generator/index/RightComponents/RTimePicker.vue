  ...
  <el-row>
    ...
    <el-form-item label="默认值">
      <el-time-picker v-model="activeData.__config__.defaultValue"
        ...
        :value-format="activeData.format" :format="activeData.format">
      </el-time-picker>
    </el-form-item>
    <el-form-item label="">
    ...
    <template v-if="activeData.__config__.startTimeRule">
      ...
      <el-form-item label="" class="spacing" v-if="activeData.__config__.startTimeType==1">
        <el-time-picker v-model="activeData.__config__.startTimeValue" placeholder="请选择开始时间"
          clearable :value-format="activeData.format" :format="activeData.format">
        </el-time-picker>
      </el-form-item>
  ...
  computed: {
    formFieldsOptions() {
      ...
      const loop = (data, parent) => {
        ...
        if (data.__vModel__ && data.__config__.jnpfKey === 'timePicker' && this.isIncludesField(data)) {
