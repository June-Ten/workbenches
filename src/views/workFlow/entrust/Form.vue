  ...
  <el-dialog :title="!dataForm.id ? '新建委托' : '编辑委托'" :close-on-click-modal="false"
    ...
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="100px"
      ...
      <!-- <jnpf-form-tip-item label="委托人" prop="userId">
        <JnpfUserSelect v-model="dataForm.userId" placeholder="选择委托人" @change="onChangeUser"
      ...
      <jnpf-form-tip-item label="受委托人" prop="toUserId">
        <JnpfUserSelect v-model="dataForm.toUserId" placeholder="选择受委托人" @change="onChange" />
      </jnpf-form-tip-item>
