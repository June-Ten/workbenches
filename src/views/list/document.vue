<template>
  <div class="document">
    ...
    <div class="item">
      <p class="avue-tip-title">购买</p>
      <el-button size="small"
                 @click="goVip"
                 type="danger">点击购买源码</el-button>
    </div> -->
    <div class="item">
...
export default {
  ...
  methods: {
    goMenu1 () {
      window.open(`${window.location.origin}${window.location.pathname}view.html?Kvid=` + this.value)
    },
    goMenu2 () {
      window.open(`${window.location.origin}${window.location.pathname}swiper.html?id=` + this.value1)
    },
    goApi () {
