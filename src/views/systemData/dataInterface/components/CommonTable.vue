    ...
    <el-table :data="data" ref="dragTable" row-key="id" size='mini' height="100%" width="100%">
      ...
      <el-table-column prop="field" label="参数值" width="285">
        <template slot-scope="scope">
          ...
          <el-select v-model="scope.row.defaultValue" placeholder="请选择" v-if="scope.row.source == 4"
            :disabled="!scope.row.source" style="width: 100%;">
...
export default {
  ...
  data() {
    return {
      ...
      pagingParameters: [{ label: 'currentPage', value: 'currentPage' }, { label: 'pageSize', value: 'pageSize' }, { label: 'keyword', value: 'keyword' }],
