    ...
    <el-row class="main">
      ...
      <el-col :span="22" :offset="1">
        <el-tabs v-model="activeName">
          <el-tab-pane label="接口集合" name="first"></el-tab-pane>
          <el-tab-pane label="用户集合" name="second"></el-tab-pane>
        </el-tabs>
      </el-col>
      <el-col :span="20" :offset="2" class="mt-20" v-show="activeName=='first'">
        <el-table v-loading="listLoading" :data="tableList" @cell-dblclick="cellDblclick">
          ...
          <el-table-column prop="fullName" label="接口名称" width="150" />
          <el-table-column prop="enCode" label="接口编码" width="150" />
          ...
          <el-table-column prop="type" label="接口类型" width="120" align="center">
            <template slot-scope="scope">
              <el-tag v-if="scope.row.type">POST</el-tag>
      ...
      <el-col :span="20" :offset="2" class="mt-20" v-show="activeName=='second'">
      ...
      getInfo(this.dataForm.id).then(res => {
        ...
        if (res.data.list) {
          ...
          res.data.list.forEach(item => {
            ...
            if (item.parameterJson) {
              item.paramList = [...JSON.parse(item.parameterJson)]
            }
