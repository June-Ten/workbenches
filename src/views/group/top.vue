<template>
  <div class="top-nav">
    <el-menu class="nav" mode="horizontal" background-color="#212528" text-color="#fff" active-text-color="#2681ff"
      ...
      <el-submenu :index="index + ''" v-for="(item, index) in baseList" :key="index">
        ...
        <div style="width:390px">
          <el-menu-item v-for="(citem, cindex) in item.children" @click="handleAdd(citem.option, true)" :key="cindex"
            class="menu-inline" :index="`${index}-${cindex}`">
            <div class="usehove">
...
export default {
  ...
  mounted() {
    // console.log(website, '111111111111111111111111111')
  },
  methods: {
