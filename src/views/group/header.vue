<template>
  <div class="head">
    ...
    <div class="head_info">
      ...
      <span>JQBI-{{ contain.visual.title }}</span>
    </div>
    ...
    handleBuild(fn, tip, first = false) {
      ...
      this.$nextTick(() => {
        html2canvas(document.getElementById('content'), {
          ...
          axios.post(url + '/Restful/JinQue.DataV.Entities.blade_visual/UploadFile.json', formdata, {
            headers: {
            ...
            console.log(this.contain.visual.Kvid)
            console.log(this.contain.config)
            const formdata = {
              visual: {
                Kvid: this.contain.visual.Kvid,
                background_url: url
              },
              config: {
                Kvid: this.contain.obj.config.Kvid,
                visualKvid: this.contain.visual.Kvid,
