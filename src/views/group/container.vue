  ...
  <div class="middle">
    <div id="wrapper" class="wrapper">
      <div class="content" id="content" ref="content" :style="contentStyle">
        <div class="container" :style="styleName" id="container" @mousedown="contain.handleInitActive()" ref="container">
...
export default {
  ...
  computed: {
    ...
    styleName() {
      ...
      return Object.assign({
        ...
        backgroundColor: `${window.location.origin}${window.location.pathname}` + this.contain.config.backgroundColor
      }, (() => {
        if (this.contain.config.backgroundImage) {
          return {
            background: `url(${window.location.origin}${window.location.pathname}${this.contain.config.backgroundImage}) 0% 0% / 100% 100% rgb(3, 12, 59)`,
          }
        }
        return
      })())
  ...
  methods: {
    ...
    initData() {
      ...
      let Kvid = getSearchParams().Kvid;
      const id = this.id || Kvid
      let config;
