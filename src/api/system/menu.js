...
export const exportMenu = id => {
  return request({
    url: `/api/system/Menu/${id}/Actions/Export`,
    method: 'GET'
  })
}
...
//查看权限组
export const getPermissionGroup = (id) => {
  return request({
    url: `/api/system/Menu/getPermissionGroup/${id}`,
    method: 'GET'
  })
}

//通过权限组id获取相关权限”
export const getPermission = (id, permissionId) => {
  return request({
    url: `/api/system/Menu/getPermission/${id}/${permissionId}`,
    method: 'GET'
  })
}
