        ...
        return new Promise((resolve, reject) => {
          ...
          const getData = () => {
            ...
            if (isApi) {
              ...
              let formData = new FormData();
              let data12 = JSON.parse(crypto.decrypt(safe.sql));

              //console.log(crypto.decrypt(JSON.stringify(safe.sql)))
              formData.append("sqltxt",crypto.encrypt(data12.sql))
              this.sqlFormatter(formData).then(res => {
