 ...
 * meta : {
    ...
    noCache: true                if set true, the views will no be cached(default is false)
...
/**
 * constantRoutes
 * a base views that does not have permission requirements
...
},
{
  ...
  {
    path: '/desk',
    component: (resolve) => require(['@/views/dekstop'], resolve),
    hidden: true
  },
{
  path: '/sso',
